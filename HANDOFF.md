...
Sinkage-focused passive test added:
...
The tested knobs that changed the behavior were contact pressure and material
yield/compliance: radius 0.04 m instead of 0.08 m, `E=5e4` instead of `1e5`,
and `friction_angle=35` instead of `45`. This is the current best passive
