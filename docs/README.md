...
deformed splats, and simple deformation metrics.
...
5. [Phase 4: MPM Pressure Patch](04_phase_mpm_pressure_patch.md)
...
the shallow pressure prototype works.
...
- apply a shallow circular displacement or pressure,
